...
class ParkingController(Node):
    ...
    def __init__(self):
        ...
        self.parking_distance = 1.0  # meters; desired stop distance from cone
        self.relative_x = 0
        self.relative_y = 0
        ...
        self.parking_tolerance = 0.1  # meters; stop if within this of parking_distance
    ...
    def relative_cone_callback(self, msg):
        ...
        #     # Cone is behin back up with flipped pursuit steering.
